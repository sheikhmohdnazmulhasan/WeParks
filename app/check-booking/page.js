    ...
    return (
        <div className='max-w-3xl mx-auto my-20'>
            ...
            <div className="border p-4 hidden">
                ...
                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Name: </h4>
                    <h4 className='flex-1 pl-60'>nazmul@xxx.com</h4>
                </div>
                <div className="flex justify-between  mb-6 border-b items-center">
                ...
                <div className="flex justify-between  mb-6 border-b items-center">
                    ...
                    <h4 className='flex-1 pl-60'>2024-03-16T14:37</h4>
                </div>
                ...
                <div className="flex justify-between  mb-6 border-b items-center">
                    ...
                    <h4 className='flex-1 pl-60'> £ 2133</h4>
                </div>

                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Discount Rate: </h4>
                    <h4 className='flex-1 pl-60'> 30%</h4>
                </div>

                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Discount: </h4>
                    <h4 className='flex-1 pl-60'> £ 21</h4>
                </div>

                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Subtotal: </h4>
                    <h4 className='flex-1 pl-60'> £ 210</h4>
                </div>

                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Airport: </h4>
                    <h4 className='flex-1 pl-60'> ASSS</h4>
                </div>
                ...
                <div className="flex justify-between  mb-6 border-b items-center">
                    ...
                    <h4 className='flex-1 pl-60'> eeed</h4>
                </div>

                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Vehicle Model Year: </h4>
                    <h4 className='flex-1 pl-60'> 2043</h4>
                </div>

                <div className="flex justify-between  mb-6 border-b items-center">
                    <h4 className=' flex-1'>Payment Verified: </h4>
                    <h4 className='flex-1 pl-60'> False</h4>
                </div>
            ...
            <div className=" mt-4 flex hidden justify-end pl-5">
